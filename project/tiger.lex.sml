...
\\000"
 ...
 (1, 
"\000\000\000\000\000\000\000\000\000\014\013\000\000\000\000\000\
\\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
\\012\000\010\000\000\000\003\000\003\003\003\003\003\003\003\006\
...
"\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\
\\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\
\\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\009\
\\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\
\\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\
\\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\
\\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\
...
\\010\010\010\010\010\010\010\010\010\010\010\010\010\010\010\010\
\\010\010\011\010\010\010\010\010\010\010\010\010\010\010\010\010\
\\010\010\010\010\010\010\010\010\010\010\010\010\010\010\010\010\
\\010\010\010\010\010\010\010\010\010\010\010\010\010\010\010\010\
\\010\010\010\010\010\010\010\010\010\010\010\010\010\010\010\010\
\\010\010\010\010\010\010\010\010\010\010\010\010\010\010\010\010\
...
let fun continue() = lex() in
 ...
 in (yybufpos := i; case yyk of 
  ...
  1 => ((*#line 36.20 "tiger.lex"*)let
                    ...
                    in
                        lex() (* whitespace *)
                    end(*#line 200.1 "tiger.lex.sml"*)
)
| 18 => let val yytext=yymktext() in (*#line 62.40 "tiger.lex"*)let
                        val p_prev = !pos_from_prev
                        val _ = reset pos_from_prev
                    in
                        Tokens.Comment (yytext, !line_no, p_prev)
                    end (* comment *)(*#line 207.1 "tiger.lex.sml"*)
 end
| 21 => let val yytext=yymktext() in (*#line 69.21 "tiger.lex"*)let
                        val p_prev = !pos_from_prev
                        val _ = reset pos_from_prev
                    in
...
| 3 => ((*#line 42.20 "tiger.lex"*)let
                    ...
                    in
                        lex() (* whitespace *)
                    end(*#line 220.1 "tiger.lex.sml"*)
)
| 41 => let val yytext=yymktext() in (*#line 76.118 "tiger.lex"*)let
                        val p_prev = !pos_from_prev
                        val _ = reset pos_from_prev
                    in
                        Tokens.Symbol (yytext, !line_no, p_prev)
                    end(*#line 227.1 "tiger.lex.sml"*)
 end
| 44 => let val yytext=yymktext() in (*#line 82.21 "tiger.lex"*)let
                        val p_prev = !pos_from_prev
                        val _ = reset pos_from_prev
                    in
                        Tokens.AlphaStr (yytext, !line_no, p_prev)
                    end(*#line 234.1 "tiger.lex.sml"*)
 end
| 5 => ((*#line 48.21 "tiger.lex"*)let
                    ...
                    in 
                        lex() (* newline *)
                    end(*#line 241.1 "tiger.lex.sml"*)
)
| 9 => let val yytext=yymktext() in (*#line 55.25 "tiger.lex"*)let
                        val p_prev = !pos_from_prev
                        val _ = reset pos_from_prev
                    in
                        Tokens.String (yytext, !line_no, p_prev)
                    end (* string *)(*#line 248.1 "tiger.lex.sml"*)
 end
